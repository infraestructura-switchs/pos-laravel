    ...
    <div class="overflow-hidden">
      ...
      <ul class="leading-4 whitespace-nowrap space-y-1">
        ...
        <li>
          ...
          <span class="font-medium" x-text="user || '<?php echo e(auth()->user()->name); ?>'"></span>
        </li>
        <li>
...
<?php /**PATH C:\Users\USUARIO\Documents\proyecto-pos\app-pos-laravel\resources\views/pdfs/ticket-open-cash-register.blade.php ENDPATH**/ ?>