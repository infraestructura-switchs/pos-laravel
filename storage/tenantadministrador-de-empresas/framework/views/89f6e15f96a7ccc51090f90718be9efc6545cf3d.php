...
<?php endif; ?>
  ...
  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loads.panel-fixed','data' => ['text' => 'Procesando factura...','class' => 'no-print z-[999]','wire:loading' => true,'wire:target' => 'storeBill']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('loads.panel-fixed'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['text' => 'Procesando factura...','class' => 'no-print z-[999]','wire:loading' => true,'wire:target' => 'storeBill']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
} elseif ($_instance->childHasBeenRendered('l3789281991-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3789281991-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3789281991-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3789281991-0');
} else {
    $response = \Livewire\Livewire::mount('admin.quick-sale.customers', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3789281991-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3789281991-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3789281991-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3789281991-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3789281991-1');
} else {
    $response = \Livewire\Livewire::mount('admin.customers.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3789281991-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l3789281991-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3789281991-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3789281991-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3789281991-2');
} else {
    $response = \Livewire\Livewire::mount('admin.quick-sale.change', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3789281991-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
  ...
  <!-- Modal de WhatsApp -->
  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.whatsapp-modal','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('whatsapp-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php endif; ?>
  ...
  <script>
    ...
    function directSaleStoreBill(cash, tip = 0, paymentMethod = '1') {
      window.livewire.find('<?php echo e($_instance->id); ?>').call('storeBill', window.directSaleOrder, cash, tip, paymentMethod).then((result) => {
        if (result === 'success') {
          window.directSaleOrder = null;
    ...
    async function sendWhatsappNow(billId, phoneNumber) {
      try {
        ...
        const result = await window.livewire.find('<?php echo e($_instance->id); ?>').call('sendBillViaWhatsapp', billId, phoneNumber);
...
} elseif ($_instance->childHasBeenRendered('l3789281991-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l3789281991-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3789281991-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3789281991-3');
} else {
    $response = \Livewire\Livewire::mount('admin.quick-sale.products', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3789281991-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
</div><?php /**PATH C:\Users\USUARIO\Documents\proyecto-pos\app-pos-laravel\resources\views/livewire/admin/direct-sale/create.blade.php ENDPATH**/ ?>