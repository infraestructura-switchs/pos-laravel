                  ...
                  <div class="grid grid-cols-3 gap-6 mt-6">
                      ...
                      @if (!$has_inventory)
                          ...
                          <div class="grid {{ $has_presentations ? 'grid-cols-1' : 'grid-cols-2' }} gap-6">
                              <x-wireui.input onlyNumbers label="Stock" wire:model.defer="stock" placeholder="Cantidad de stock" readonly />
                              @if (!$has_presentations)
                                  <x-wireui.input onlyNumbers label="Unidades" wire:model.defer="units" placeholder="Unidades"    readonly />
                              @endif
                          </div>
