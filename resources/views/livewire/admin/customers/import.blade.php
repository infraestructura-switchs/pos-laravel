<div>
    <x-wireui.modal wire:model.defer="openImport" >
        <x-wireui.card title="Importar clientes desde excel">
            <div>
                ...
                <div class="text-sm text-red-500">
                    ...
                    <p>
                        Esta opción borrará todos los clientes agregados anteriormente de la base de datos
                    </p>
                </div>
            ...
            <x-slot:footer>
                <div class="flex justify-end items-center space-x-3">
                    ...
                    @if ($file)
                        <x-wireui.button wire:click="loadProducts" text="Cargar clientes" load textLoad="Cargando..." wire:key="button1" />
                    @else
                        <x-wireui.button disabled text="Cargar clientes" wire:key="button2" />
                    @endif
                </div>
            </x-slot:footer>
        </x-wireui.card>
