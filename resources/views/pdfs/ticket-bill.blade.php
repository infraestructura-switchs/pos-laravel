...
<div x-data="alpineTicketBill()" class="print">
  <div x-show="show" class="absolute -z-40 font-roboto top-0 left-0 bg-white py-10 !text-[12px] px-4 w-full">
    ...
    <div class="text-xs mt-4">
      <p class="text-center leading-4">Elaborado por: <span x-text="company.invoice_provider.name"></span></p>
      <p class="text-center leading-4"><span x-text="company.invoice_provider.url"></span> NIT: <span x-text="company.invoice_provider.nit"></span></p>
    </div>
